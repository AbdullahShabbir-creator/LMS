  ...
  return (
    <footer style={{
      ...
      <div style={{ display: 'flex', gap: 14 }}>
        <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" aria-label="Facebook" style={{ color: '#185a9d', fontSize: 20, textDecoration: 'none', transition: 'color 0.2s' }}>
        ...
        <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" aria-label="Twitter" style={{ color: '#185a9d', fontSize: 20, textDecoration: 'none', transition: 'color 0.2s' }}>
        ...
        <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" style={{ color: '#185a9d', fontSize: 20, textDecoration: 'none', transition: 'color 0.2s' }}>
